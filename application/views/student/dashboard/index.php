        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                ...
                <div class="row">
                    ...
                    <?php
                    $nis = $user['nis_siswa']; // Ambil NIS dari user
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <p>
                                                ...
                                                // Tampilkan hasil
                                                echo "Izin: $izin_count | Sakit: $sakit_count | Alpha: $alpha_count";
                                                ?>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <p>Jumlah: <?= $this->db->query("SELECT * FROM tabel_libur WHERE MONTH(tanggal) = MONTH(CURRENT_DATE()) AND YEAR(tanggal) = YEAR(CURRENT_DATE()) AND status = 'Aktif'")->num_rows() ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
