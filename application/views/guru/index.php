    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Data Guru & Karyawan</a></li>
            </ol>
        </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?= base_url(); ?>guru/add">Tambah</a>
                            ...
                            <table id="example" class="display min-w850">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($siswa as $s) : ?>
                                        <?php if ($s['type'] == '1') : // Filter untuk hanya type 1 ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td><?= $s['nis']; ?></td>
                                                <td><?= $s['nama_siswa']; ?></td>
