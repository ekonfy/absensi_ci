            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        Login admin = <a href="<?= base_url(); ?>Auth" >Login Admin</a><br>
                        ...
                        <div class="kotaklogin">
                            ...
                            <form>
                                ...
                                <div class="form-button">
                                    ...
                                    <!-- <a href="forget4.html">Lupa password?</a> --><br>
                                    <a href="<?= base_url('student/auth/linked_account') ?>">Kilk >> NIS belum terkait akun? >> untuk buat password siswa</a>
                                </div>
                            </form>
                        </div>
